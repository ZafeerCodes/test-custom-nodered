...
for folder in "${folders[@]}"; do
  ...
  echo "PERCEPTO_BACKEND_API=http://localhost:4500" >> "$env_file"
  echo "PERCEPTO_NODE_RED_API=http://localhost:1880" >> "$env_file"
  echo "PERCEPTO_LOCAL_NGINX_URL=http://localhost:3077" >> "$env_file"
